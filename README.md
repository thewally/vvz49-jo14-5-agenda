# Speelagenda VVZ'49 JO14-5

Automatisch bijgewerkte agenda-feed (.ics) voor **ST SO Soest/VVZ'49 O14-5**
(de combinatie tussen SO Soest en VVZ'49), voor gebruik als abonnement in
Google Calendar, Outlook of Apple Calendar.
...
- **Overige activiteiten** — trainingen, toernooien, teamuitjes (optioneel, zie hieronder)
...
2. Plak de URL: `https://thewally.github.io/vvz49-jo14-5-agenda/matches.ics`
...
3. Plak de URL: `https://thewally.github.io/vvz49-jo14-5-agenda/matches.ics`
4. Geef de agenda een naam (bv. "JO14-5") en klik op **Importeren**
...
Gebaseerd op [vvz49-jo14-6-agenda](https://github.com/thewally/vvz49-jo14-6-agenda),
dezelfde opzet voor de andere JO14-teams van deze samenwerking.
